...
- (void)viewDidLoad {
    ...
    [self createNavgationButtonWithImageNmae:nil title:@"完成" target:self action:@selector(doneBtnClicked:) type:UINavigationItem_Type_RightItem];
...
//    }];
    ...
    //    添加myTableView
    _XIUTableView = ({
        UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, KWIDTH, KHEIGHT) style:UITableViewStyleGrouped];
